...
#define COREI3C_BASE_ADDR                         0x70000000UL
...
#define TIMER1_IRQn                     External_31_IRQn
 ...
 CoreI3C INT_O is connected to MIV_RV32 MSYS_EI[0]. Enable it in firmware with:
     MRV_enable_local_irq(MRV32_MSYS_EIE0_IRQn);
 and implement MSYS_EI0_IRQHandler() as the ISR.
 */
