...
/*=========================================================================*//**
  @mainpage Sample file detailing how fpga_design_config.h should be constructed
  for the Mi-V processors.
    ...
    and store it in the root folder of your project. Then customize it per your
    HW design.
...
#define COREI2C0_BASE_ADDR              0x70004000U
#define COREI2C1_BASE_ADDR              0x70005000U
